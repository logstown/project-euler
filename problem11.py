nums = ["08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08".split(),
...
for y in range(0,17):
	for x in range(0,17):
		...
		for i in range(0,4):
			...
			down = 1
			for j in range(0,4):
				right *= int(nums[y+i][x+j])
				down *= int(nums[y+j][x+i])
			...
			diag1 *= int(nums[y+i][x+i])
			diag2 *= int(nums[y+i][x+(3-i)])
